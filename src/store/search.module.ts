...
declare module '@vue/runtime-core' {
    interface StateSearch {
        searchByEpisode: boolean,
        query:string,
        filtersSelected: {status:string,gender:string,whatToSearch:string},
        whatToSearch: [
        ...
        gender: [
            ...
            {name: string, text: string},
            {name: string, text: string}],
        nexturlCharacters: string,
        nexturlEpisodes: string,
    }
...
export const  searchModule : Module<any,any>= {
    ...
    mutations: {
        setNextCharacters(state, url:string){
            state.nexturlCharacters = url
        },
        setNextEpisodes(state, url:string){
            state.nexturlEpisodes= url
        },
        setSearchByEpisode(state, value){
            state.searchByEpisode=value
        },
        setSelectedFiltersWhatToWatch(state, value:string){
            if(value=="episodes")
        ...
        setSelectedFilters(state, value:string) {
            switch (value) {
                case "Alive":
